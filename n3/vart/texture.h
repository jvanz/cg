...
/// you must compile V-Art with IL_LIB symbol.
    class Texture {
        public:
            ...
            /// returns false.
            const bool HasTextureLoad() const { return hasTexture; };
...
#ifdef IL_LIB
            /// At the first call of an Texture constructor, the Developer Image Library
            /// must be initialized. This is done internaly, to hide from the programmer this
            /// V-Art dependency.
            static bool ilInitalized;
            static void IlInitialize();
#endif //IL_LIB
